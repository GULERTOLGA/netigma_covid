...
class _TotalDeathsState extends State<TotalDeaths> with AutomaticKeepAliveClientMixin<TotalDeaths>{
   ...
   return  ListView.separated( separatorBuilder: (BuildContext context, int index) =>
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return ListTile(
            ...
            title: Text(title),
            trailing: Text(val != null ? formatter.format(val): val) ,
  ...
  var flags = <String,Image>{
    ...
    "South Korea":Image.asset('assets/flags/kp.png', fit: BoxFit.contain, width: 40, height: 40,),
    "Korea":Image.asset('assets/flags/kr.png', fit: BoxFit.contain, width: 40, height: 40,),
